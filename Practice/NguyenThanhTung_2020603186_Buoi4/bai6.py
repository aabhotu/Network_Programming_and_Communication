...
def send_email():
    ...
    try:
        for receiver_email in receiver_emails:
            ...
            rar_file_path = "test.rar"
            with open(rar_file_path, "rb") as file:
                attachment = MIMEApplication(file.read(), Name="file.rar")
            attachment["Content-Disposition"] = 'attachment; filename="file.rar"'
            message.attach(attachment)
